{{- define "CsFileHeader"}}// Code generated by https://github.com/ahfuzhang/BaoHuLu. DO NOT EDIT.
// source: {{.Namespace}}
...
{{with .Msg}}
{{- template "CsTagsBlock" .}}
{{- template "CsWriterBlock" .}}
{{end}}{{end}}
{{- define "CsReadonlyFile"}}{{template "CsFileHeader" .}}
{{with .Msg}}
{{- template "CsReadonlyBlock" .}}
{{end}}{{end}}
{{template "CsFileHeader" .}}
// ─── Enums ───────────────────────────────────────────────────────────────────
{{range .Enums}}
